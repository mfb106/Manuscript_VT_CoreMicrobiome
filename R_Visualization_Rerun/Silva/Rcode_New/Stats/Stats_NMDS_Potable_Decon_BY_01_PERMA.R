...
ADONIS2.All.PotablePOCPOU.bray.multiple_comparisons.terms<-adonis2(All.PotablePOCPOU.dist.bray ~ 
                                                               Treatment_Classification_Cat+
                                                               Mixed_Source_Water+
                                                               Potable_Source_Water+
                                                               Treatment_Classification_Number+
                                                 ...
                                                 permutations = permutations,
                                                 by="terms")
ADONIS2.All.PotablePOCPOU.bray.multiple_comparisons.terms
