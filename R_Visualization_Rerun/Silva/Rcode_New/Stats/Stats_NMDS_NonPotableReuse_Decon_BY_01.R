...
ADONIS2.All.NonPotableReusePOCPOU.bray.multiple_comparisons<-adonis2(All.NonPotableReusePOCPOU.dist.bray ~ 
                                                                   Classification_1+Climate, 
                                                                 data = All.NonPotableReusePOCPOU.meta, 
                                                                 permutations = permutations)
ADONIS2.All.NonPotableReusePOCPOU.bray.multiple_comparisons
