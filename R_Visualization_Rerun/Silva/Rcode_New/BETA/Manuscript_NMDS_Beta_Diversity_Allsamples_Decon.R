...
ggsave("POCPOU.wateruse.bray.unrare.NMDS.jpeg", 
       ...
       path="C:/Users/matth/OneDrive - Virginia Tech/Manuscripts/Amplicon_Comparison/Figures/R_Visualization_Rerun/Silva/Ordination/CA_Figures/UnRare/Bray/All/POCPOU", 
...
Meta.All.POC.Filter<-Meta.All.POC[Meta.All.POC$Classification_1 == 'Potable Conventional'| Meta.All.POC$Classification_1 =='Non-potable Reuse'|Meta.All.POC$Classification_1 =='Potable Reuse'|Meta.All.POC$Classification_1 =='Bottled Water',]#can add Blank
...
##Can swap to different Analysis if Needed 
#bray.weight.unrare.NMDS.POC.ordu <- ordinate(physeq.combined.All.POC, method="NMDS", distance="bray", weighted=TRUE, k=2, maxit = 5000, trymax = 500, previous.best)
...
ggsave("POC.wateruse.bray.unrare.NMDS.jpeg", 
       ...
       path="C:/Users/matth/OneDrive - Virginia Tech/Manuscripts/Amplicon_Comparison/Figures/R_Visualization_Rerun/Silva/Ordination/CA_Figures/UnRare/Bray/All/POC", 
       scale = 1, width = 8.5, height = 8, units = "in", dpi = 300)
...
Meta.All.POU.Filter<-Meta.All.POU[Meta.All.POU$Classification_1 == 'Potable Conventional'| Meta.All.POU$Classification_1 =='Non-potable Reuse'|Meta.All.POU$Classification_1 =='Potable Reuse'|Meta.All.POU$Classification_1 =='Bottled Water',]#can add Blank
...
ggsave("POU.wateruse.bray.unrare.NMDS.jpeg", 
       ...
       path="C:/Users/matth/OneDrive - Virginia Tech/Manuscripts/Amplicon_Comparison/Figures/R_Visualization_Rerun/Silva/Ordination/CA_Figures/UnRare/Bray/All/POU", 
       scale = 1, width = 8.5, height = 8, units = "in", dpi = 300)
