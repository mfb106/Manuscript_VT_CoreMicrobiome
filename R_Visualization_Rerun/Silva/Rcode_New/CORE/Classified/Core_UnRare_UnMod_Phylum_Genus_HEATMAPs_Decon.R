...
PA_means_Phylum<-read.xlsx("C:/Users/matth/OneDrive - Virginia Tech/Manuscripts/Amplicon_Comparison/Figures/R_Visualization_Rerun/Silva/Core/Combined_edited.xlsx", sheet= 'Phylum', rowNames = FALSE)
PA_means_Genus<-read.xlsx("C:/Users/matth/OneDrive - Virginia Tech/Manuscripts/Amplicon_Comparison/Figures/R_Visualization_Rerun/Silva/Core/Combined_edited.xlsx", sheet= 'Genus', rowNames = FALSE)
...
#Heatmap, Phylum 
Final_Join_Phylum_Long_Norare_NoMod<-ggplot(Final_PA_means_Phylum_Long,aes(Classifcation,reorder(Phylum,Presence),fill=Presence))+
  geom_tile()+
...
Final_Join_Phylum_Long_Norare_NoMod
leg_phylum <- get_legend(Final_Join_Phylum_Long_Norare_NoMod)
...
#Heatmap, Genus 
Final_Join_Genus_Long_Norare_NoMod<-ggplot(Final_PA_means_Genus_Long,aes(Classifcation,reorder(Genus,Presence),fill=Presence))+
  geom_tile()+
...
Final_Join_Genus_Long_Norare_NoMod
leg_Genus <- get_legend(Final_Join_Genus_Long_Norare_NoMod)
as_ggplot(leg_Genus)



##Export
ggsave("Final_Join_Phylum_Long_Norare_NoMod.png",plot = Final_Join_Phylum_Long_Norare_NoMod,path = "C:/Users/matth/OneDrive - Virginia Tech/Manuscripts/Amplicon_Comparison/Figures/R_Visualization_Rerun/Silva/Core/Figures/", width = 20, height = 16, units = "in", dpi = 300)
ggsave("Final_Join_Genus_Long_Norare_NoMod.png",plot = Final_Join_Genus_Long_Norare_NoMod,path = "C:/Users/matth/OneDrive - Virginia Tech/Manuscripts/Amplicon_Comparison/Figures/R_Visualization_Rerun/Silva/Core/Figures/", width = 20, height = 16, units = "in", dpi = 300)

#Combo Figure
Manuscript_Combo <- ggarrange(Final_Join_Phylum_Long_Norare_NoMod,
                              Final_Join_Genus_Long_Norare_NoMod,
                              labels = c("A", "B"),
...
ggsave("Manuscript_Combo_2.png",plot = Manuscript_Combo,path = "C:/Users/matth/OneDrive - Virginia Tech/Manuscripts/Amplicon_Comparison/Figures/R_Visualization_Rerun/Silva/Core/Figures/", width = 18, height = 16, units = "in", dpi = 300)
...
#Export Excels 
write.xlsx(Final_PA_means_Phylum,"C:/Users/matth/OneDrive - Virginia Tech/Manuscripts/Amplicon_Comparison/Figures/R_Visualization_Rerun/Silva/Core/Figures/Final_PA_means_Phylum_Nomod_Norare.xlsx")
write.xlsx(Final_PA_means_Genus,"C:/Users/matth/OneDrive - Virginia Tech/Manuscripts/Amplicon_Comparison/Figures/R_Visualization_Rerun/Silva/Core/Figures/Final_PA_means_Genus_Nomod_Norare.xlsx")
