...
Final_level1_Collapsed_OTUs_Trans_Merged<-transform(merge(Meta.All.POCPOU,level1_Collapsed_OTUs_Trans,by=0), row.names=Row.names, Row.names=NULL)
Final_level1_Collapsed_OTUs_Trans_Merged_PA<-transform(merge(Meta.All.POCPOU,level1_Collapsed_OTUs_Trans_PA,by=0), row.names=Row.names, Row.names=NULL)

Final_level2_Collapsed_OTUs_Trans_Merged<-transform(merge(Meta.All.POCPOU,level2_Collapsed_OTUs_Trans,by=0), row.names=Row.names, Row.names=NULL)
Final_level2_Collapsed_OTUs_Trans_Merged_PA<-transform(merge(Meta.All.POCPOU,level2_Collapsed_OTUs_Trans_PA,by=0), row.names=Row.names, Row.names=NULL)

Final_level3_Collapsed_OTUs_Trans_Merged<-transform(merge(Meta.All.POCPOU,level3_Collapsed_OTUs_Trans,by=0), row.names=Row.names, Row.names=NULL)
Final_level3_Collapsed_OTUs_Trans_Merged_PA<-transform(merge(Meta.All.POCPOU,level3_Collapsed_OTUs_Trans_PA,by=0), row.names=Row.names, Row.names=NULL)

Final_level4_Collapsed_OTUs_Trans_Merged<-transform(merge(Meta.All.POCPOU,level4_Collapsed_OTUs_Trans,by=0), row.names=Row.names, Row.names=NULL)
Final_level4_Collapsed_OTUs_Trans_Merged_PA<-transform(merge(Meta.All.POCPOU,level4_Collapsed_OTUs_Trans_PA,by=0), row.names=Row.names, Row.names=NULL)

Final_level5_Collapsed_OTUs_Trans_Merged<-transform(merge(Meta.All.POCPOU,level5_Collapsed_OTUs_Trans,by=0), row.names=Row.names, Row.names=NULL)
Final_level5_Collapsed_OTUs_Trans_Merged_PA<-transform(merge(Meta.All.POCPOU,level5_Collapsed_OTUs_Trans_PA,by=0), row.names=Row.names, Row.names=NULL)

Final_level6_Collapsed_OTUs_Trans_Merged<-transform(merge(Meta.All.POCPOU,level6_Collapsed_OTUs_Trans,by=0), row.names=Row.names, Row.names=NULL)
Final_level6_Collapsed_OTUs_Trans_Merged_PA<-transform(merge(Meta.All.POCPOU,level6_Collapsed_OTUs_Trans_PA,by=0), row.names=Row.names, Row.names=NULL)
...
#######
#######
PA_level2_All<-as.data.frame(Final_level2_Collapsed_OTUs_Trans_Merged_PA[Final_level2_Collapsed_OTUs_Trans_Merged_PA$Sample_Local == 'POC'| Final_level2_Collapsed_OTUs_Trans_Merged_PA$Sample_Local =='Bottled Water'| Final_level2_Collapsed_OTUs_Trans_Merged_PA$Sample_Local =='POU'| Final_level2_Collapsed_OTUs_Trans_Merged_PA$Sample_Local =='Blank',])
...
Final_PA_level2_All_Collasped<-PA_level2_All_Tran

Final_PA_level2_All_Collasped[]<-as.data.frame(lapply(Final_PA_level2_All_Collasped,as.numeric))
Final_PA_level2_All_Collasped_Mean<-as.data.frame(rowMeans(Final_PA_level2_All_Collasped,na.rm=TRUE))
...
Final_PA_level2_All_Pot_Collasped<-PA_level2_All_Pot_Tran

Final_PA_level2_All_Pot_Collasped[]<-as.data.frame(lapply(Final_PA_level2_All_Pot_Collasped,as.numeric))
Final_PA_level2_All_Pot_Collasped_Mean<-as.data.frame(rowMeans(Final_PA_level2_All_Pot_Collasped,na.rm=TRUE))
...
Final_PA_level2_All_Reuse_Collasped<-PA_level2_All_Reuse_Tran

Final_PA_level2_All_Reuse_Collasped[]<-as.data.frame(lapply(Final_PA_level2_All_Reuse_Collasped,as.numeric))
Final_PA_level2_All_Reuse_Collasped_Mean<-as.data.frame(rowMeans(Final_PA_level2_All_Reuse_Collasped,na.rm=TRUE))
...
Final_PA_level2_All_Reclaim_Collasped<-PA_level2_All_Reclaim_Tran

Final_PA_level2_All_Reclaim_Collasped[]<-as.data.frame(lapply(Final_PA_level2_All_Reclaim_Collasped,as.numeric))
Final_PA_level2_All_Reclaim_Collasped_Mean<-as.data.frame(rowMeans(Final_PA_level2_All_Reclaim_Collasped,na.rm=TRUE))
...
Final_PA_level2_All_PotReuse_Collasped<-PA_level2_All_PotReuse_Tran

Final_PA_level2_All_PotReuse_Collasped[]<-as.data.frame(lapply(Final_PA_level2_All_PotReuse_Collasped,as.numeric))
Final_PA_level2_All_PotReuse_Collasped_Mean<-as.data.frame(rowMeans(Final_PA_level2_All_PotReuse_Collasped,na.rm=TRUE))
...
Final_PA_level2_All_BottledWater_Collasped<-PA_level2_All_BottledWater_Tran

Final_PA_level2_All_BottledWater_Collasped[]<-as.data.frame(lapply(Final_PA_level2_All_BottledWater_Collasped,as.numeric))
Final_PA_level2_All_BottledWater_Collasped_Mean<-as.data.frame(rowMeans(Final_PA_level2_All_BottledWater_Collasped,na.rm=TRUE))
...
Final_PA_level2_All_Blank_Collasped<-PA_level2_All_Blank_Tran

Final_PA_level2_All_Blank_Collasped[]<-as.data.frame(lapply(Final_PA_level2_All_Blank_Collasped,as.numeric))
Final_PA_level2_All_Blank_Collasped_Mean<-as.data.frame(rowMeans(Final_PA_level2_All_Blank_Collasped,na.rm=TRUE))

#Export Raw Files

list_PA_level2_All <- list(
  "All_Collasped" = Final_PA_level2_All_Collasped,
  "All_Pot_Collasped" = Final_PA_level2_All_Pot_Collasped ,
  "All_Reuse_Collasped" = Final_PA_level2_All_Reuse_Collasped,
  "All_Reclaim_Collasped" = Final_PA_level2_All_Reclaim_Collasped,
  "All_PotReuse_Collasped" = Final_PA_level2_All_PotReuse_Collasped,
  "Blanks"=Final_PA_level2_All_Blank_Collasped,
  "BottledWater"=Final_PA_level2_All_BottledWater_Collasped)

write.xlsx(list_PA_level2_All,colNames=TRUE,rowNames=TRUE, file = "C:/Users/matth/OneDrive - Virginia Tech/Manuscripts/Amplicon_Comparison/Figures/R_Visualization_Rerun/Silva/Core/All/PA_level2_ALL_Collasped.xlsx")

#Merge and Export Averaged for Heatmap 
list_PA_level2_All_mean <- list(
  "All_Collasped_Mean" = Final_PA_level2_All_Collasped_Mean,
  "All_Pot_Collasped_Mean" = Final_PA_level2_All_Pot_Collasped_Mean ,
  "All_Reuse_Collasped_Mean" = Final_PA_level2_All_Reuse_Collasped_Mean,
  "All_Reclaim_Collasped_Mean" = Final_PA_level2_All_Reclaim_Collasped_Mean,
  "All_PotReuse_Collasped_Mean" = Final_PA_level2_All_PotReuse_Collasped_Mean,
  "Blanks_Mean"=Final_PA_level2_All_Blank_Collasped_Mean,
  "BottledWater_Mean"=Final_PA_level2_All_BottledWater_Collasped_Mean)

write.xlsx(list_PA_level2_All_mean,colNames=TRUE,rowNames=TRUE, file = "C:/Users/matth/OneDrive - Virginia Tech/Manuscripts/Amplicon_Comparison/Figures/R_Visualization_Rerun/Silva/Core/All/PA_level2_ALL_Collasped_mean.xlsx")


list_rn_PA_level2_All_mean <- lapply(list_PA_level2_All_mean, rownames_to_column)
PA_level2_All_mean<- list_rn_PA_level2_All_mean %>% reduce(full_join, by= "rowname")

write.xlsx(PA_level2_All_mean,colNames=TRUE, file = "C:/Users/matth/OneDrive - Virginia Tech/Manuscripts/Amplicon_Comparison/Figures/R_Visualization_Rerun/Silva/Core/All/PA_level2_All_mean.xlsx")
...
#######
#######
PA_level6_All<-as.data.frame(Final_level6_Collapsed_OTUs_Trans_Merged_PA[Final_level6_Collapsed_OTUs_Trans_Merged_PA$Sample_Local == 'POC'| Final_level6_Collapsed_OTUs_Trans_Merged_PA$Sample_Local =='Bottled Water'| Final_level6_Collapsed_OTUs_Trans_Merged_PA$Sample_Local =='POU'| Final_level6_Collapsed_OTUs_Trans_Merged_PA$Sample_Local =='Blank',])
...
Final_PA_level6_All_Collasped<-PA_level6_All_Tran

Final_PA_level6_All_Collasped[]<-as.data.frame(lapply(Final_PA_level6_All_Collasped,as.numeric))
Final_PA_level6_All_Collasped_Mean<-as.data.frame(rowMeans(Final_PA_level6_All_Collasped,na.rm=TRUE))
...
Final_PA_level6_All_Pot_Collasped<-PA_level6_All_Pot_Tran

Final_PA_level6_All_Pot_Collasped[]<-as.data.frame(lapply(Final_PA_level6_All_Pot_Collasped,as.numeric))
Final_PA_level6_All_Pot_Collasped_Mean<-as.data.frame(rowMeans(Final_PA_level6_All_Pot_Collasped,na.rm=TRUE))
...
Final_PA_level6_All_Reuse_Collasped<-PA_level6_All_Reuse_Tran

Final_PA_level6_All_Reuse_Collasped[]<-as.data.frame(lapply(Final_PA_level6_All_Reuse_Collasped,as.numeric))
Final_PA_level6_All_Reuse_Collasped_Mean<-as.data.frame(rowMeans(Final_PA_level6_All_Reuse_Collasped,na.rm=TRUE))
...
Final_PA_level6_All_Reclaim_Collasped<-PA_level6_All_Reclaim_Tran

Final_PA_level6_All_Reclaim_Collasped[]<-as.data.frame(lapply(Final_PA_level6_All_Reclaim_Collasped,as.numeric))
Final_PA_level6_All_Reclaim_Collasped_Mean<-as.data.frame(rowMeans(Final_PA_level6_All_Reclaim_Collasped,na.rm=TRUE))
...
Final_PA_level6_All_PotReuse_Collasped<-PA_level6_All_PotReuse_Tran

Final_PA_level6_All_PotReuse_Collasped[]<-as.data.frame(lapply(Final_PA_level6_All_PotReuse_Collasped,as.numeric))
Final_PA_level6_All_PotReuse_Collasped_Mean<-as.data.frame(rowMeans(Final_PA_level6_All_PotReuse_Collasped,na.rm=TRUE))
...
Final_PA_level6_All_BottledWater_Collasped<-PA_level6_All_BottledWater_Tran

Final_PA_level6_All_BottledWater_Collasped[]<-as.data.frame(lapply(Final_PA_level6_All_BottledWater_Collasped,as.numeric))
Final_PA_level6_All_BottledWater_Collasped_Mean<-as.data.frame(rowMeans(Final_PA_level6_All_BottledWater_Collasped,na.rm=TRUE))
...
Final_PA_level6_All_Blank_Collasped<-PA_level6_All_Blank_Tran

Final_PA_level6_All_Blank_Collasped[]<-as.data.frame(lapply(Final_PA_level6_All_Blank_Collasped,as.numeric))
Final_PA_level6_All_Blank_Collasped_Mean<-as.data.frame(rowMeans(Final_PA_level6_All_Blank_Collasped,na.rm=TRUE))

#Export Raw Files

list_PA_level6_All <- list(
  "All_Collasped" = Final_PA_level6_All_Collasped,
  "All_Pot_Collasped" = Final_PA_level6_All_Pot_Collasped ,
  "All_Reuse_Collasped" = Final_PA_level6_All_Reuse_Collasped,
  "All_Reclaim_Collasped" = Final_PA_level6_All_Reclaim_Collasped,
  "All_PotReuse_Collasped" = Final_PA_level6_All_PotReuse_Collasped,
  "Blanks"=Final_PA_level6_All_Blank_Collasped,
  "BottledWater"=Final_PA_level6_All_BottledWater_Collasped)

write.xlsx(list_PA_level6_All,colNames=TRUE,rowNames=TRUE, file = "C:/Users/matth/OneDrive - Virginia Tech/Manuscripts/Amplicon_Comparison/Figures/R_Visualization_Rerun/Silva/Core/All/PA_level6_ALL_Collasped.xlsx")

#Merge and Export Averaged for Heatmap 
list_PA_level6_All_mean <- list(
  "All_Collasped_Mean" = Final_PA_level6_All_Collasped_Mean,
  "All_Pot_Collasped_Mean" = Final_PA_level6_All_Pot_Collasped_Mean ,
  "All_Reuse_Collasped_Mean" = Final_PA_level6_All_Reuse_Collasped_Mean,
  "All_Reclaim_Collasped_Mean" = Final_PA_level6_All_Reclaim_Collasped_Mean,
  "All_PotReuse_Collasped_Mean" = Final_PA_level6_All_PotReuse_Collasped_Mean,
  "Blanks_Mean"=Final_PA_level6_All_Blank_Collasped_Mean,
  "BottledWater_Mean"=Final_PA_level6_All_BottledWater_Collasped_Mean)

write.xlsx(list_PA_level6_All_mean,colNames=TRUE,rowNames=TRUE, file = "C:/Users/matth/OneDrive - Virginia Tech/Manuscripts/Amplicon_Comparison/Figures/R_Visualization_Rerun/Silva/Core/All/PA_level6_ALL_Collasped_mean.xlsx")


list_rn_PA_level6_All_mean <- lapply(list_PA_level6_All_mean, rownames_to_column)
PA_level6_All_mean<- list_rn_PA_level6_All_mean %>% reduce(full_join, by= "rowname")

write.xlsx(PA_level6_All_mean,colNames=TRUE, file = "C:/Users/matth/OneDrive - Virginia Tech/Manuscripts/Amplicon_Comparison/Figures/R_Visualization_Rerun/Silva/Core/All/PA_level6_All_mean.xlsx")
...
#######
#######
PA_level6_POC<-as.data.frame(Final_level6_Collapsed_OTUs_Trans_Merged_PA[Final_level6_Collapsed_OTUs_Trans_Merged_PA$Sample_Local == 'POC'| Final_level6_Collapsed_OTUs_Trans_Merged_PA$Sample_Local =='Blank',])
...
Final_PA_level6_POC_Collasped<-PA_level6_POC_Tran

Final_PA_level6_POC_Collasped[]<-as.data.frame(lapply(Final_PA_level6_POC_Collasped,as.numeric))
Final_PA_level6_POC_Collasped_Mean<-as.data.frame(rowMeans(Final_PA_level6_POC_Collasped,na.rm=TRUE))
...
Final_PA_level6_POC_Pot_Collasped<-PA_level6_POC_Pot_Tran

Final_PA_level6_POC_Pot_Collasped[]<-as.data.frame(lapply(Final_PA_level6_POC_Pot_Collasped,as.numeric))
Final_PA_level6_POC_Pot_Collasped_Mean<-as.data.frame(rowMeans(Final_PA_level6_POC_Pot_Collasped,na.rm=TRUE))
...
Final_PA_level6_POC_Reuse_Collasped<-PA_level6_POC_Reuse_Tran

Final_PA_level6_POC_Reuse_Collasped[]<-as.data.frame(lapply(Final_PA_level6_POC_Reuse_Collasped,as.numeric))
Final_PA_level6_POC_Reuse_Collasped_Mean<-as.data.frame(rowMeans(Final_PA_level6_POC_Reuse_Collasped,na.rm=TRUE))
...
Final_PA_level6_POC_Reclaim_Collasped<-PA_level6_POC_Reclaim_Tran

Final_PA_level6_POC_Reclaim_Collasped[]<-as.data.frame(lapply(Final_PA_level6_POC_Reclaim_Collasped,as.numeric))
Final_PA_level6_POC_Reclaim_Collasped_Mean<-as.data.frame(rowMeans(Final_PA_level6_POC_Reclaim_Collasped,na.rm=TRUE))
...
Final_PA_level6_POC_PotReuse_Collasped<-PA_level6_POC_PotReuse_Tran

Final_PA_level6_POC_PotReuse_Collasped[]<-as.data.frame(lapply(Final_PA_level6_POC_PotReuse_Collasped,as.numeric))
Final_PA_level6_POC_PotReuse_Collasped_Mean<-as.data.frame(rowMeans(Final_PA_level6_POC_PotReuse_Collasped,na.rm=TRUE))
...
Final_PA_level6_POC_BottledWater_Collasped<-PA_level6_POC_BottledWater_Tran

Final_PA_level6_POC_BottledWater_Collasped[]<-as.data.frame(lapply(Final_PA_level6_POC_BottledWater_Collasped,as.numeric))
Final_PA_level6_POC_BottledWater_Collasped_Mean<-as.data.frame(rowMeans(Final_PA_level6_POC_BottledWater_Collasped,na.rm=TRUE))
...
Final_PA_level6_POC_Blank_Collasped<-PA_level6_POC_Blank_Tran

Final_PA_level6_POC_Blank_Collasped[]<-as.data.frame(lapply(Final_PA_level6_POC_Blank_Collasped,as.numeric))
Final_PA_level6_POC_Blank_Collasped_Mean<-as.data.frame(rowMeans(Final_PA_level6_POC_Blank_Collasped,na.rm=TRUE))

#Export Raw Files

list_PA_level6_POC <- list(
  "POC_Collasped" = Final_PA_level6_POC_Collasped,
  "POC_Pot_Collasped" = Final_PA_level6_POC_Pot_Collasped ,
  "POC_Reuse_Collasped" = Final_PA_level6_POC_Reuse_Collasped,
  "POC_Reclaim_Collasped" = Final_PA_level6_POC_Reclaim_Collasped,
  "POC_PotReuse_Collasped" = Final_PA_level6_POC_PotReuse_Collasped,
  "Blanks"=Final_PA_level6_POC_Blank_Collasped,
  "BottledWater"=Final_PA_level6_POC_BottledWater_Collasped)

write.xlsx(list_PA_level6_POC,colNames=TRUE,rowNames=TRUE, file = "C:/Users/matth/OneDrive - Virginia Tech/Manuscripts/Amplicon_Comparison/Figures/R_Visualization_Rerun/Silva/Core/POC/PA_level6_POC_Collasped.xlsx")

#Merge and Export Averaged for Heatmap 
list_PA_level6_POC_mean <- list(
  "POC_Collasped_Mean" = Final_PA_level6_POC_Collasped_Mean,
  "POC_Pot_Collasped_Mean" = Final_PA_level6_POC_Pot_Collasped_Mean ,
  "POC_Reuse_Collasped_Mean" = Final_PA_level6_POC_Reuse_Collasped_Mean,
  "POC_Reclaim_Collasped_Mean" = Final_PA_level6_POC_Reclaim_Collasped_Mean,
  "POC_PotReuse_Collasped_Mean" = Final_PA_level6_POC_PotReuse_Collasped_Mean,
  "Blanks_Mean"=Final_PA_level6_POC_Blank_Collasped_Mean,
  "BottledWater_Mean"=Final_PA_level6_POC_BottledWater_Collasped_Mean)

write.xlsx(list_PA_level6_POC_mean,colNames=TRUE,rowNames=TRUE, file = "C:/Users/matth/OneDrive - Virginia Tech/Manuscripts/Amplicon_Comparison/Figures/R_Visualization_Rerun/Silva/Core/POC/PA_level6_POC_Collasped_mean.xlsx")


list_rn_PA_level6_POC_mean <- lapply(list_PA_level6_POC_mean, rownames_to_column)
PA_level6_POC_mean<- list_rn_PA_level6_POC_mean %>% reduce(full_join, by= "rowname")

write.xlsx(PA_level6_POC_mean,colNames=TRUE, file = "C:/Users/matth/OneDrive - Virginia Tech/Manuscripts/Amplicon_Comparison/Figures/R_Visualization_Rerun/Silva/Core/POC/PA_level6_POC_mean.xlsx")
...
#######
#######
PA_level2_POC<-as.data.frame(Final_level2_Collapsed_OTUs_Trans_Merged_PA[Final_level2_Collapsed_OTUs_Trans_Merged_PA$Sample_Local =='Bottled Water'| Final_level2_Collapsed_OTUs_Trans_Merged_PA$Sample_Local =='POC'| Final_level2_Collapsed_OTUs_Trans_Merged_PA$Sample_Local =='Blank',])
...
Final_PA_level2_POC_Collasped<-PA_level2_POC_Tran

Final_PA_level2_POC_Collasped[]<-as.data.frame(lapply(Final_PA_level2_POC_Collasped,as.numeric))
Final_PA_level2_POC_Collasped_Mean<-as.data.frame(rowMeans(Final_PA_level2_POC_Collasped,na.rm=TRUE))
...
Final_PA_level2_POC_Pot_Collasped<-PA_level2_POC_Pot_Tran

Final_PA_level2_POC_Pot_Collasped[]<-as.data.frame(lapply(Final_PA_level2_POC_Pot_Collasped,as.numeric))
Final_PA_level2_POC_Pot_Collasped_Mean<-as.data.frame(rowMeans(Final_PA_level2_POC_Pot_Collasped,na.rm=TRUE))
...
Final_PA_level2_POC_Reuse_Collasped<-PA_level2_POC_Reuse_Tran

Final_PA_level2_POC_Reuse_Collasped[]<-as.data.frame(lapply(Final_PA_level2_POC_Reuse_Collasped,as.numeric))
Final_PA_level2_POC_Reuse_Collasped_Mean<-as.data.frame(rowMeans(Final_PA_level2_POC_Reuse_Collasped,na.rm=TRUE))
...
Final_PA_level2_POC_Reclaim_Collasped<-PA_level2_POC_Reclaim_Tran

Final_PA_level2_POC_Reclaim_Collasped[]<-as.data.frame(lapply(Final_PA_level2_POC_Reclaim_Collasped,as.numeric))
Final_PA_level2_POC_Reclaim_Collasped_Mean<-as.data.frame(rowMeans(Final_PA_level2_POC_Reclaim_Collasped,na.rm=TRUE))
...
Final_PA_level2_POC_PotReuse_Collasped<-PA_level2_POC_PotReuse_Tran

Final_PA_level2_POC_PotReuse_Collasped[]<-as.data.frame(lapply(Final_PA_level2_POC_PotReuse_Collasped,as.numeric))
Final_PA_level2_POC_PotReuse_Collasped_Mean<-as.data.frame(rowMeans(Final_PA_level2_POC_PotReuse_Collasped,na.rm=TRUE))
...
Final_PA_level2_POC_BottledWater_Collasped<-PA_level2_POC_BottledWater_Tran

Final_PA_level2_POC_BottledWater_Collasped[]<-as.data.frame(lapply(Final_PA_level2_POC_BottledWater_Collasped,as.numeric))
Final_PA_level2_POC_BottledWater_Collasped_Mean<-as.data.frame(rowMeans(Final_PA_level2_POC_BottledWater_Collasped,na.rm=TRUE))
...
Final_PA_level2_POC_Blank_Collasped<-PA_level2_POC_Blank_Tran

Final_PA_level2_POC_Blank_Collasped[]<-as.data.frame(lapply(Final_PA_level2_POC_Blank_Collasped,as.numeric))
Final_PA_level2_POC_Blank_Collasped_Mean<-as.data.frame(rowMeans(Final_PA_level2_POC_Blank_Collasped,na.rm=TRUE))

#Export Raw Files

list_PA_level2_POC <- list(
  "POC_Collasped" = Final_PA_level2_POC_Collasped,
  "POC_Pot_Collasped" = Final_PA_level2_POC_Pot_Collasped ,
  "POC_Reuse_Collasped" = Final_PA_level2_POC_Reuse_Collasped,
  "POC_Reclaim_Collasped" = Final_PA_level2_POC_Reclaim_Collasped,
  "POC_PotReuse_Collasped" = Final_PA_level2_POC_PotReuse_Collasped,
  "Blanks"=Final_PA_level2_POC_Blank_Collasped,
  "BottledWater"=Final_PA_level2_POC_BottledWater_Collasped)

write.xlsx(list_PA_level2_POC,colNames=TRUE,rowNames=TRUE, file = "C:/Users/matth/OneDrive - Virginia Tech/Manuscripts/Amplicon_Comparison/Figures/R_Visualization_Rerun/Silva/Core/POC/PA_level2_POC_Collasped.xlsx")

#Merge and Export Averaged for Heatmap 
list_PA_level2_POC_mean <- list(
  "POC_Collasped_Mean" = Final_PA_level2_POC_Collasped_Mean,
  "POC_Pot_Collasped_Mean" = Final_PA_level2_POC_Pot_Collasped_Mean ,
  "POC_Reuse_Collasped_Mean" = Final_PA_level2_POC_Reuse_Collasped_Mean,
  "POC_Reclaim_Collasped_Mean" = Final_PA_level2_POC_Reclaim_Collasped_Mean,
  "POC_PotReuse_Collasped_Mean" = Final_PA_level2_POC_PotReuse_Collasped_Mean,
  "Blanks_Mean"=Final_PA_level2_POC_Blank_Collasped_Mean,
  "BottledWater_Mean"=Final_PA_level2_POC_BottledWater_Collasped_Mean)

write.xlsx(list_PA_level2_POC_mean,colNames=TRUE,rowNames=TRUE, file = "C:/Users/matth/OneDrive - Virginia Tech/Manuscripts/Amplicon_Comparison/Figures/R_Visualization_Rerun/Silva/Core/POC/PA_level2_POC_Collasped_mean.xlsx")


list_rn_PA_level2_POC_mean <- lapply(list_PA_level2_POC_mean, rownames_to_column)
PA_level2_POC_mean<- list_rn_PA_level2_POC_mean %>% reduce(full_join, by= "rowname")

write.xlsx(PA_level2_POC_mean,colNames=TRUE, file = "C:/Users/matth/OneDrive - Virginia Tech/Manuscripts/Amplicon_Comparison/Figures/R_Visualization_Rerun/Silva/Core/POC/PA_level2_POC_mean.xlsx")
...
#######
#######
PA_level6_POU<-as.data.frame(Final_level6_Collapsed_OTUs_Trans_Merged_PA[Final_level6_Collapsed_OTUs_Trans_Merged_PA$Sample_Local == 'POC'| Final_level6_Collapsed_OTUs_Trans_Merged_PA$Sample_Local =='Bottled Water'| Final_level6_Collapsed_OTUs_Trans_Merged_PA$Sample_Local =='POU'| Final_level6_Collapsed_OTUs_Trans_Merged_PA$Sample_Local =='Blank',])
...
Final_PA_level6_POU_Collasped<-PA_level6_POU_Tran

Final_PA_level6_POU_Collasped[]<-as.data.frame(lapply(Final_PA_level6_POU_Collasped,as.numeric))
Final_PA_level6_POU_Collasped_Mean<-as.data.frame(rowMeans(Final_PA_level6_POU_Collasped,na.rm=TRUE))
...
Final_PA_level6_POU_Pot_Collasped<-PA_level6_POU_Pot_Tran

Final_PA_level6_POU_Pot_Collasped[]<-as.data.frame(lapply(Final_PA_level6_POU_Pot_Collasped,as.numeric))
Final_PA_level6_POU_Pot_Collasped_Mean<-as.data.frame(rowMeans(Final_PA_level6_POU_Pot_Collasped,na.rm=TRUE))
...
Final_PA_level6_POU_Reuse_Collasped<-PA_level6_POU_Reuse_Tran

Final_PA_level6_POU_Reuse_Collasped[]<-as.data.frame(lapply(Final_PA_level6_POU_Reuse_Collasped,as.numeric))
Final_PA_level6_POU_Reuse_Collasped_Mean<-as.data.frame(rowMeans(Final_PA_level6_POU_Reuse_Collasped,na.rm=TRUE))
...
Final_PA_level6_POU_Reclaim_Collasped<-PA_level6_POU_Reclaim_Tran

Final_PA_level6_POU_Reclaim_Collasped[]<-as.data.frame(lapply(Final_PA_level6_POU_Reclaim_Collasped,as.numeric))
Final_PA_level6_POU_Reclaim_Collasped_Mean<-as.data.frame(rowMeans(Final_PA_level6_POU_Reclaim_Collasped,na.rm=TRUE))
...
Final_PA_level6_POU_PotReuse_Collasped<-PA_level6_POU_PotReuse_Tran

Final_PA_level6_POU_PotReuse_Collasped[]<-as.data.frame(lapply(Final_PA_level6_POU_PotReuse_Collasped,as.numeric))
Final_PA_level6_POU_PotReuse_Collasped_Mean<-as.data.frame(rowMeans(Final_PA_level6_POU_PotReuse_Collasped,na.rm=TRUE))
...
Final_PA_level6_POU_BottledWater_Collasped<-PA_level6_POU_BottledWater_Tran

Final_PA_level6_POU_BottledWater_Collasped[]<-as.data.frame(lapply(Final_PA_level6_POU_BottledWater_Collasped,as.numeric))
Final_PA_level6_POU_BottledWater_Collasped_Mean<-as.data.frame(rowMeans(Final_PA_level6_POU_BottledWater_Collasped,na.rm=TRUE))
...
Final_PA_level6_POU_Blank_Collasped<-PA_level6_POU_Blank_Tran

Final_PA_level6_POU_Blank_Collasped[]<-as.data.frame(lapply(Final_PA_level6_POU_Blank_Collasped,as.numeric))
Final_PA_level6_POU_Blank_Collasped_Mean<-as.data.frame(rowMeans(Final_PA_level6_POU_Blank_Collasped,na.rm=TRUE))

#Export Raw Files

list_PA_level6_POU <- list(
  "POU_Collasped" = Final_PA_level6_POU_Collasped,
  "POU_Pot_Collasped" = Final_PA_level6_POU_Pot_Collasped ,
  "POU_Reuse_Collasped" = Final_PA_level6_POU_Reuse_Collasped,
  "POU_Reclaim_Collasped" = Final_PA_level6_POU_Reclaim_Collasped,
  "POU_PotReuse_Collasped" = Final_PA_level6_POU_PotReuse_Collasped,
  "Blanks"=Final_PA_level6_POU_Blank_Collasped,
  "BottledWater"=Final_PA_level6_POU_BottledWater_Collasped)

write.xlsx(list_PA_level6_POU,colNames=TRUE,rowNames=TRUE, file = "C:/Users/matth/OneDrive - Virginia Tech/Manuscripts/Amplicon_Comparison/Figures/R_Visualization_Rerun/Silva/Core/POU/PA_level6_POU_Collasped.xlsx")

#Merge and Export Averaged for Heatmap 
list_PA_level6_POU_mean <- list(
  "POU_Collasped_Mean" = Final_PA_level6_POU_Collasped_Mean,
  "POU_Pot_Collasped_Mean" = Final_PA_level6_POU_Pot_Collasped_Mean ,
  "POU_Reuse_Collasped_Mean" = Final_PA_level6_POU_Reuse_Collasped_Mean,
  "POU_Reclaim_Collasped_Mean" = Final_PA_level6_POU_Reclaim_Collasped_Mean,
  "POU_PotReuse_Collasped_Mean" = Final_PA_level6_POU_PotReuse_Collasped_Mean,
  "Blanks_Mean"=Final_PA_level6_POU_Blank_Collasped_Mean,
  "BottledWater_Mean"=Final_PA_level6_POU_BottledWater_Collasped_Mean)

write.xlsx(list_PA_level6_POU_mean,colNames=TRUE,rowNames=TRUE, file = "C:/Users/matth/OneDrive - Virginia Tech/Manuscripts/Amplicon_Comparison/Figures/R_Visualization_Rerun/Silva/Core/POU/PA_level6_POU_Collasped_mean.xlsx")


list_rn_PA_level6_POU_mean <- lapply(list_PA_level6_POU_mean, rownames_to_column)
PA_level6_POU_mean<- list_rn_PA_level6_POU_mean %>% reduce(full_join, by= "rowname")

write.xlsx(PA_level6_POU_mean,colNames=TRUE, file = "C:/Users/matth/OneDrive - Virginia Tech/Manuscripts/Amplicon_Comparison/Figures/R_Visualization_Rerun/Silva/Core/POU/PA_level6_POU_mean.xlsx")
